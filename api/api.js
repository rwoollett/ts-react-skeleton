...
const homepage_json_1 = __importDefault(require("./homepage.json"));
const toolkit_1 = require("@reduxjs/toolkit");
const txtgen_1 = require("txtgen");
const seedrandom_1 = __importDefault(require("seedrandom"));
let rng = (0, seedrandom_1.default)();
...
module.exports = {
    defineApi: function (app) {
        app.get('/api/v1/homepage', function (req, res) {
            res.json(homepage_json_1.default.homepage);
        });
        ...
        app.get('/api/v1/posts', function (req, res) {
            ...
            res.json([
                ...
                },
                {
                    id: (0, toolkit_1.nanoid)(),
                    date: new Date(2021, 5, 12, 16, 30, 12),
                    title: (0, txtgen_1.sentence)(),
                    content: (0, txtgen_1.article)(1),
                    user: "300",
                    reactions: {
                        thumbsUp: 0,
                        hooray: 0,
